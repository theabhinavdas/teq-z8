...
@section('title', 'Encrypted Chat Application In Python - Final Year Projects - Z8 Labs')
@section('page-title', 'Encrypted Chat Application In Python')
@section('first-block')
...
@endsection
@section('keywords', 'Encryption, Cryptography, Chat, XMPP, Python')